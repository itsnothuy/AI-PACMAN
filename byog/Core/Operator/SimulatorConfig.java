...
public class SimulatorConfig {
    ...
    public PacMan pacManController;

    public TrucController trucsController;
    ...
    public SimulatorConfig clone() {
        ...
        result.trucsController = trucsController;
    ...
    public String getOptions() {
        return   SimulatorConfigOption.GAME_LEVELS_TO_PLAY.option + " " + game.levelsToPlay
                ...
                + " " + SimulatorConfigOption.GAME_TRUC_COUNT.option + " " + (trucsController == null ? "N/A" : trucsController.getTrucCount())
    ...
    public static SimulatorConfig fromOptions(String options) {
        ...
        for(int i = 0; i < parts.length; i += 2) {
            ...
            if (option.equals(SimulatorConfigOption.GAME_TRUC_COUNT.option)) {
                int trucCount = Integer.parseInt(value);
                result.trucsController = new Truc(trucCount);
            }
